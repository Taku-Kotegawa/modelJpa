...
-- changeset taku:1693035817263-1
CREATE TABLE "confirm_histroy" ("execute_date" date NOT NULL, "confirm_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "equip_id" BIGINT, "execute_by" BIGINT, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "check_status" VARCHAR(255) NOT NULL, "created_by" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, CONSTRAINT "confirm_histroy_pkey" PRIMARY KEY ("confirm_id"));
...
-- changeset taku:1693035817263-2
...
-- changeset taku:1693035817263-3
CREATE TABLE "confirm_history" ("execute_date" date NOT NULL, "confirm_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "equip_id" BIGINT, "execute_by" BIGINT, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "check_status" VARCHAR(255) NOT NULL, "created_by" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, CONSTRAINT "confirm_history_pkey" PRIMARY KEY ("confirm_id"));
...
-- changeset taku:1693035817263-4
CREATE TABLE "employee" ("created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "emp_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "organization_id" BIGINT, "position_id" BIGINT, "version" BIGINT NOT NULL, "created_by" VARCHAR(255) NOT NULL, "email" VARCHAR(255), "emp_name" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "password" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "employee_pkey" PRIMARY KEY ("emp_id"));
...
-- changeset taku:1693035817263-5
CREATE TABLE "equip_type" ("created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "equip_type_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "version" BIGINT NOT NULL, "created_by" VARCHAR(255) NOT NULL, "equip_type" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "equip_type_pkey" PRIMARY KEY ("equip_type_id"));
...
-- changeset taku:1693035817263-6
...
-- changeset taku:1693035817263-7
CREATE TABLE "organization" ("created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "director_id" BIGINT, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "organization_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "parent_id" BIGINT, "version" BIGINT NOT NULL, "created_by" VARCHAR(255) NOT NULL, "group_name" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "organization_pkey" PRIMARY KEY ("organization_id"));
...
-- changeset taku:1693035817263-8
CREATE TABLE "position" ("created_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_modified_date" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "position_id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "version" BIGINT NOT NULL, "created_by" VARCHAR(255) NOT NULL, "last_modified_by" VARCHAR(255) NOT NULL, "position_name" VARCHAR(255) NOT NULL, "status" VARCHAR(255) NOT NULL, CONSTRAINT "position_pkey" PRIMARY KEY ("position_id"));
...
-- changeset taku:1693035817263-9
...
-- changeset taku:1693035817263-15
...
-- changeset taku:1693035817263-16
...
-- changeset taku:1693035817263-17
...
-- changeset taku:1693035817263-18
...
-- changeset taku:1693035817263-19
...
-- changeset taku:1693035817263-20
...
-- changeset taku:1693035817263-21
...
-- changeset taku:1693035817263-22
...
-- changeset taku:1693035817263-23
...
-- changeset taku:1693035817263-24
...
-- changeset taku:1693035817263-25
...
-- changeset taku:1693035817263-26
